...
- [:heavy_check_mark:] __GET /videogames__:
  - Obtener un listado de los videojuegos
  - Debe devolver solo los datos necesarios para la ruta principal
- [:heavy_check_mark:] __GET /videogames?name="..."__:
...
- [:heavy_check_mark:] Al menos tener una ruta del backend con sus tests respectivos
- [:heavy_check_mark:] Al menos tener un modelo de la base de datos con sus tests respectivos
